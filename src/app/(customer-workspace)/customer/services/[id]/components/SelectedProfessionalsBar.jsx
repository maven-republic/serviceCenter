...
// 📌 Fixed bottom bar for selected professionals - with proper spacing adjustments
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        // Full width positioning with sidebar adjustment
        "left-0 right-0 lg:left-28", // lg:left-28 accounts for the 112px (w-28) sidebar
        className
      )}>
