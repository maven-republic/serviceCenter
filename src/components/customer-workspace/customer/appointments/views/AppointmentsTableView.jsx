// src/components/customer-workspace/customer/appointments/views/AppointmentsTableView.jsx
"use client";
...
/**
 * Complete Table View for Appointments
 * Self-contained view that can be swapped with other views
 */
export const AppointmentsTableView = ({ appointments }) => {
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') {
      console.group('📋 AppointmentsTableView - Data Validation');
